...
WebUI.setText(findTestObject('Object Repository/AmazonWeb/Pagina mis direcciones/Campo calle'), 'Avenida Cantabria')
...
WebUI.click(findTestObject('AmazonWeb/Pagina mis direcciones/Boton confirmar direccion'))

WebUI.navigateToUrl('https://www.amazon.es/a/addresses?alertId=yaab-enterAddressSucceed')

WebUI.verifyElementPresent(findTestObject('Object Repository/AmazonWeb/Pagina mis direcciones/Boton descartar'), 15)

WebUI.click(findTestObject('Object Repository/AmazonWeb/Pagina mis direcciones/Boton descartar'))

WebUI.click(findTestObject('AmazonWeb/Pagina mis direcciones/Campo si (borrar)'))

WebUI.click(findTestObject('AmazonWeb/Pagina mis direcciones/Boton si (borrar)'))

WebUI.delay(5)

WebUI.verifyElementNotPresent(findTestObject('Object Repository/AmazonWeb/Pagina mis direcciones/Boton descartar'), 15)
